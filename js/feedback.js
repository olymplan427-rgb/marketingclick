...
// 세부 항목은 현재(베타) 사이드바에 노출되는 기능만 반영 — FEATURE_FLAGS로 숨겨진 경쟁학원
// 모니터링/인스타그램 연동은 제외해뒀다가, 나중에 베타에 풀리면 여기도 같이 추가할 것.
var FEEDBACK_CATEGORIES = [
  { label: '콘텐츠 문의', subs: ['AI 글작성', 'AI 소재추천', '히스토리', '이미지 스튜디오'] },
  { label: '시장 조사 문의', subs: ['주변 학원 검색', '지역 트렌드 AI리포트', '학교 점유율'] },
  { label: '계정/크레딧 문의', subs: ['로그인/계정', '설정', '크레딧'] },
  { label: '기타 문의', subs: [] }
];
