...
// 대분류는 사이드바 섹션 제목(블로그/시장트렌드/도구)과, 세부 항목은 사이드바 실제 메뉴 이름과
// 1:1로 동일하게 맞춤(index.html 참고) — 세부 항목은 현재(베타) 사이드바에 노출되는 기능만 반영,
// FEATURE_FLAGS로 숨겨진 경쟁학원 모니터링/인스타그램 연동은 제외해뒀다가 베타에 풀리면 추가할 것.
var FEEDBACK_CATEGORIES = [
  { label: '블로그', subs: ['AI 글작성', 'AI 소재추천', '히스토리'] },
  { label: '시장트렌드', subs: ['주변 학원 검색', '지역 트렌드 AI리포트', '학교 점유율'] },
  { label: '도구', subs: ['이미지 스튜디오'] },
