...
var BLOG_PROMPT_VERSION = 'v9-length-count-includes-whitespace-2026-09-03';
...
function getBlogDraftSystem(type) {
  ...
  var lengthGuide = '목표 분량은 ' + targetLen + '자(공백 포함, 최종 결과물 전체 기준)이다. ' + sectionGuide;
...
function blogBuildInputText() {
  ...
  if (inp.length)    parts.push('목표 분량: ' + inp.length + '자 (공백 포함)');
